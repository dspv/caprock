...
**Last updated: 2026-08-26** · Owner: Dima · Phase: **Phase 2 complete; the product is released and paid plans are live**
...
- **Paid plans:** free, $30/year or $5/month, $100 once. A licence key with its own expiry unlocks paid features, checked offline ([ADR-022](08-decisions.md)); Stripe issues it and emails it on payment. The team tier is specified, not built ([ADR-021](08-decisions.md)).
