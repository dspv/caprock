...
- **Agent coverage:** Claude Code, OpenCode, Gemini CLI and Codex share the observation screens. Claude Code has the complete Observe → Control → Orchestrate path; OpenCode and Codex are observation-only; Caprock can start and observe Gemini sessions. The exact boundaries live in [16-opencode.md](16-opencode.md), [19-codex.md](19-codex.md) and [14-build-status.md](14-build-status.md).
