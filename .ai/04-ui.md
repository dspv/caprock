...
- **Limit forecast**: "at current pace you hit the 5-hour window limit in ~40 min" (learned empirically from observed throttle events; clearly labeled as estimate). Explicitly deferred past Phase 0 — it needs the observed-throttle data model (`throttle_observations`, Phase 1) — see T8 in [09-execution-plan.md](09-execution-plan.md).
