...
**Last updated: 2026-08-18** · Phase **0 — bootstrap** · Next: **T0 ConPTY spike + T1 repo bootstrap**
...
| ------------------------------- | -------- | ------------------------------------------------- |
| Documentation (`.ai/`)          | 90%      | Corpus built from spec, audit green, spec deleted |
| Phase 0 — Observe (T0–T10)      | 0%       | Not started                                       |
...
| T1      | Repo bootstrap              | not started |
| T2      | store + migrations          | not started |
| T3      | hookd + shim + installer    | not started |
| T4      | ingest                      | not started |
| T5      | rollup + pricing            | not started |
| T6      | api + live WS               | not started |
| T7      | UI: Now + Session Detail    | not started |
| T8      | UI: Cost                    | not started |
| T9      | Loop detector               | not started |
| T10     | Release hardening → v0.1.0  | not started |
